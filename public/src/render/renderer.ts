...
// ── dock (dockview-core ラップ) ────────────────────────────────────────────
//
// ユーザがドラッグで自由レイアウトできるサブパネル容器 (Corpus DESIGN.md §13.4-9)。
...
function renderDock(comp: DockComponent, ctx: RenderContext): HTMLElement {
